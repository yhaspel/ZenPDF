<!-- Pre-apply delivery copy. The committed original lives inside the patch at
     docs/reviews/handoffs/handoff-to-cli-annotate-defects.md — identical text.
     Patch: .zen-annotate-defects.patch (522,370 bytes)
     sha256: 88cadc58421a68ede67b691c18323496e28e5abfd6d433a2529e252528b784c2
     Applies with git am on main @ 6916604 (or any later main that still applies clean).
     Delete this file together with the patch after git am (step 1). -->
...
*Archived 2026-08-29 alongside `2026-08-28-annotate-defects.patch` (sha256 `88cadc58…`, verified
against this file's own header before the patch was applied). The delivery pair is kept here at the
owner's request; the committed prompt — byte-identical below the HTML comment — is
`2026-08-28-handoff-to-cli-annotate-defects.md`, which carries the **Executed** banner.*
