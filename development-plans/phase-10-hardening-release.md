...
- **AuthN/Z sweep:** the cross-user isolation fixture (P1) re-run across EVERY endpoint added since (documents, jobs, operations, esign owner + public, exports, verify); public token state machine fuzzed (wrong states, replay after completion, canceled request tokens).
